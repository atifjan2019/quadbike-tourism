...
export const metadata: Metadata = {
  ...
  description:
    "Terms and conditions for using the Quad Bike Tourism website and services.",
        ...
        <section className="py-20">
          <div className="container-site max-w-[900px]">
            ...
            <div className="space-y-6 text-[17px] leading-[30px] text-black/90">
              <p>
                Welcome to <strong>Quad Bike Tourism | Desert Dune Buggy</strong>!
              </p>
              <p>
              ...
              <p>
                ...
                conditions. Do not continue to use Quad Bike Tourism | Desert
                Dune Buggy if you do not agree to take all of the terms and
              ...
              <p>
                ...
                for the express purpose of meeting the Client&rsquo;s needs in
                respect of provision of the Company&rsquo;s stated services, in
              ...
              <p>
                We employ the use of cookies. By accessing Quad Bike Tourism |
                Desert Dune Buggy, you agreed to use cookies in agreement with
                the Quad Bike Tourism&apos;s{" "}
              ...
              <h2 className="text-2xl font-extrabold pt-2">License</h2>
              <p>
                Unless otherwise stated, Quad Bike Tourism and/or its licensors
                own the intellectual property rights for all material on Quad
                Bike Tourism | Desert Dune Buggy. All intellectual property
                rights are reserved. You may access this from Quad Bike Tourism
                | Desert Dune Buggy for your own personal use subjected to
                restrictions set in these terms and conditions.
              </p>
              <p>You must not:</p>
              <ul className="list-disc pl-6 space-y-2">
                <li>Republish material from Quad Bike Tourism | Desert Dune Buggy</li>
                <li>Sell, rent or sub-license material from Quad Bike Tourism | Desert Dune Buggy</li>
                <li>Reproduce, duplicate or copy material from Quad Bike Tourism | Desert Dune Buggy</li>
                <li>Redistribute content from Quad Bike Tourism | Desert Dune Buggy</li>
              </ul>
              <p>This Agreement shall begin on the date hereof.</p>
              <p>
                Parts of this website offer an opportunity for users to post and
                exchange opinions and information in certain areas of the
                website. Quad Bike Tourism does not filter, edit, publish or
                review Comments prior to their presence on the website. Comments
                do not reflect the views and opinions of Quad Bike Tourism, its
                agents and/or affiliates. Comments reflect the views and
                opinions of the person who post their views and opinions. To
                the extent permitted by applicable laws, Quad Bike Tourism shall
                not be liable for the Comments or for any liability, damages or
                expenses caused and/or suffered as a result of any use of and/or
                posting of and/or appearance of the Comments on this website.
              </p>
              <p>
                Quad Bike Tourism reserves the right to monitor all Comments
              ...
              <p>
                You hereby grant Quad Bike Tourism a non-exclusive license to
              ...
              <p>
                ...
                of Quad Bike Tourism; and (d) the link is in the context of
              ...
              <p>
                ...
                by sending an e-mail to Quad Bike Tourism. Please include your
              ...
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li>
                  ...
                  on the linking party&rsquo;s site.
                </li>
              </ul>
              <p>
                No use of Quad Bike Tourism&apos;s logo or other artwork will be
                allowed for linking absent a trademark license agreement.
              </p>

              <h2 className="text-2xl font-extrabold pt-2">iFrames</h2>
              <p>
              ...
              <h2 className="text-2xl font-extrabold pt-2">Content Liability</h2>
              <p>
              ...
              <h2 className="text-2xl font-extrabold pt-2">Your Privacy</h2>
              <p>
                Please read{" "}
                <a className="underline" href="/privacy-policy/">
                  Privacy Policy
              ...
              <h2 className="text-2xl font-extrabold pt-2">Reservation of Rights</h2>
              <p>
                ...
                the right to amen these terms and conditions and it&rsquo;s
              ...
              <h2 className="text-2xl font-extrabold pt-2">Disclaimer</h2>
              <p>
